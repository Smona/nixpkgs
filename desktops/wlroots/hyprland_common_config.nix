...
''
  ...
  # monitor=HDMI-A-1, disable                          # Disable ghost dock monitor
  ...
  monitor=HDMI-A-1, preferred, auto-right, 1, transform, 0, bitdepth, 10 # Vertical monitor
  monitor=HDMI-A-2, preferred, auto-right, 1, transform, 0, bitdepth, 10 # Vertical monitor
