...
in
{
  ...
  home.file.".config/niri/config.kdl".text = ''
    ...
    cursor {
        ...
        xcursor-size ${builtins.toString config.gtk.cursorTheme.size}
    }
    ...
    layout {
        // use global background to share with overview
        ...
        focus-ring {
            ...
            //
            active-gradient from="#f5c2e7cc" to="#94e2d5cc" angle=30 in="oklch shorter hue"

            // You can also color the gradient relative to the entire view
            // of the workspace, rather than relative to just the window itself.
            // To do that, set relative-to="workspace-view".
            //
            inactive-gradient from="#505050" to="#808080" angle=45 relative-to="workspace-view" in="oklch longer hue"
        }
    ...
    ${
      (builtins.concatStringsSep "\n" (
        builtins.map (cmd: "spawn-at-startup \"bash\" \"-c\" \"${cmd}\"") (
          commonOptions.execStart ++ commonOptions.execAlways
        )
      ))
    }
    ...
    // never cover up window background
    window-rule {
