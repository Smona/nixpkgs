...
;; `load-theme' function.
;; 
;; Use the noctalia theme if it exists, otherwise default to catppuccin installed via catppuccin-nix
...
(if (locate-file "noctalia-theme.el" (custom-theme--load-path))
    (progn
